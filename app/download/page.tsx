...
export default function DownloadPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-24 bg-roomy-bg">
      {/* Glow de fondo */}
      <div
...
function AppleIcon({ className = "" }: { className?: string }) {
  return (
    <svg width="32" height="32" viewBox="0 0 24 24" className={className} fill="#0F172A">
